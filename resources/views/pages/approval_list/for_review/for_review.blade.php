...
<section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>Approval List</li>
            <li class="active">List to Review</li>
        </ol>
    </section>
    ...
    <section class="content">
            <div class="panel panel-black">
                <div class="panel-heading" data-toggle="collapse" data-target="#div_body_regsetup">
                        <h4 class="box-title"> <i class="fa fa-eye"></i> &nbsp<b>REVIEW LIST</b></h4></div>
                <div class="panel-body collapse in" id="div_body_regsetup">
                    <div class="row">
                        ...
                        <div class="col-lg-3" style="padding-top: 10px;">
                            <button class="btn_search btn btn-primary" onclick="Review_List.loadtable('destroy')">SEARCH</button>
                            <button class="btn_search btn btn-primary" id="btn_clear_search" onclick="Check_List.clear_search('review')">CLEAR SEARCH</button>
                        </div>
                    </div>
