        ...
        <tbody>
            <tr>
                ...
                <td>
                        ...
                        readonly id="txt_after_die_temp_core" placeholder="Input Die Temperature Core">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" class=" input_field" 
                    readonly id="txt_after_die_temp_cavity" placeholder="Input Die Temp Cavity">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" class=" input_field" 
                    readonly id="txt_after_mold_temp_ctrl" placeholder="Input Mold Temp Ctrl:">
                </td>
            </tr>
        </tbody>
    </table>
