...
<section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>Approval List</li>
            <li class="active">List to Check</li>
        </ol>
    </section>
    ...
    <section class="content">
            <div class="panel panel-black no-print">
                <div class="panel-heading" data-toggle="collapse" data-target="#div_body_regsetup">
                        <h4 class="box-title"> <i class="fa  fa-check"></i> &nbsp<b>CHECK LIST</b></h4></div>
                <div class="panel-body collapse in" id="div_body_regsetup">
                    <div class="row">
                        ...
                        <div class="col-lg-3" style="padding-top: 10px;">
                            <button class="btn_search btn btn-primary" onclick="Check_List.loadtable('destroy')">SEARCH</button>
                            <button class="btn_search btn btn-primary" id="btn_clear_search" onclick="Check_List.clear_search('check')">CLEAR SEARCH</button>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-sm table-hover" id="datatable">
                            ...
                            <tr>
                                ...
                                <th scope="col">CONDITION SET BY</th>
...
<script src="{{asset('js/approval_list.js')}}" defer></script>
