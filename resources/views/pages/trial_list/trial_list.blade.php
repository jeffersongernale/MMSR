...
<!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
            Mold Machine Registered List (TRIAL)
            <small>Control panel</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">Trial List</li>
        </ol>
    </section>
    ...
    <section class="content">
            <div class="panel panel-black">
                    <div class="panel-heading" data-toggle="collapse" data-target="#div_body_regsetup">
                           <h4 class="box-title"> <i class="fa  fa-clock-o"></i> &nbsp<b>REGISTERED SET UP TRIAL LIST</b></h4></div>
                    <div class="panel-body collapse in" id="div_body_regsetup">
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <button class="btn_search btn btn-primary" onclick="Trial_List.loadtable('destroy')">SEARCH</button>
                                <button class="btn_search btn btn-primary">ONGOING</button>
                            </div>
                        </div>
...
<script src="{{asset('js/trial_list.js')}}" defer></script>
