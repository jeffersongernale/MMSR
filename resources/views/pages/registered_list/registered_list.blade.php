    ...
    <section class="content">
            ...
            <div class="panel panel-black">
                    <div class="panel-heading" data-toggle="collapse" data-target="#div_body_regsetup">
                           <h4 class="box-title"> <i class="fa fa-list-ol"></i> &nbsp<b>REGISTERED SET UP LIST</b></h4></div>
                    <div class="panel-body collapse in" id="div_body_regsetup">
                        <div class="row">
                            ...
                            <div class="col-lg-3" style="padding-top: 10px;">
                                <button class="btn_search btn btn-primary" onclick="Reg_List.loadtable('destroy')">SEARCH</button>
                                {{-- <a class="btn_search btn btn-primary" href="/MMSR/public/draft">DRAFTS</a> --}}
