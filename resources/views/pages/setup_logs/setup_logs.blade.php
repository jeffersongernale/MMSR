...
<section class="content-header">
    ...
    <section class="content">
            <div class="panel panel-black no-print">
                <div class="panel-heading" data-toggle="collapse" data-target="#div_body_regsetup">
                        <h4 class="box-title"> <i class="fa  fa-check"></i> &nbsp<b>APPROVE SET UP LIST</b></h4></div>
                <div class="panel-body collapse in" id="div_body_regsetup">
                    <div class="row">
                        <div class="col-lg-2">
                            FROM: <input type="date" class="form-control" id="date_from">
                        </div>
                        <div class="col-lg-2">
                              TO: <input type="date" class="form-control" id="date_to">
                            </div>
                        <div class="col-lg-2"> 
                            PART NO: 
                        ...
                        <div class="col-lg-2" style="padding-top: 20px;">
                            <button class="btn_search btn btn-primary" onclick="Setup_Logs.loadtable('destroy')">SEARCH</button>
                            <button class="btn_search btn btn-primary" id="btn_clear_search" onclick="Setup_Logs.clear_search()">CLEAR</button>
                        </div>
                    </div><br>
            ...
            @include('pages.approval_list.modal.view_data')
            @include('pages.adjustment_history.modal_adj_history')
    </section>
    <div class="for_print" style="display:none">
...
<script src="{{asset('js/setup_log.js')}}" defer></script>
