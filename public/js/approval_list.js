...
var Check_List = (function(){
            ...
            "columns":[
                {
                    ...
                    "render": function ( data, type, row ) {
                        ...
                        'onclick="Check_List.ViewData('+"\'"+data+"\'"+','+"\'"+row['after_prod_id']+"\'"+
                        ')">'+
    ...
    this_data.ViewData = function(main_reg_id,after_id){
        ...
        Check_List.load_main_reg(main_reg_id); 
        Check_List.load_after_data(after_id,main_reg_id);
        // Check_List.load_before_data('',main_reg_id);
    ...
    this_data.load_after_data = function(id,main_register_id)
    {
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                Check_List.Percentage_pn_on_load('txt_after_OLFO_POS','lbl_after_neg_OLFO_POS','lbl_after_pos_OLFO_POS');
                Check_List.Percentage_pn_on_load('txt_after_OLFO_VEL','lbl_after_neg_OLFO_VEL','lbl_after_pos_OLFO_VEL');
                Check_List.Percentage_pn_on_load('txt_after_CS1_POS','lbl_after_neg_CS1_POS','lbl_after_pos_CS1_POS');
                Check_List.Percentage_pn_on_load('txt_after_CS1_VEL','lbl_after_neg_CS1_VEL','lbl_after_pos_CS1_VEL');
                Check_List.Percentage_pn_on_load('txt_after_CSMP_POS','lbl_after_neg_CSMP_POS','lbl_after_pos_CSMP_POS');
                Check_List.Percentage_pn_on_load('txt_after_CSMP_VEL','lbl_after_neg_CSMP_VEL','lbl_after_pos_CSMP_VEL');
                Check_List.Percentage_pn_on_load('txt_after_CST_POS','lbl_after_neg_CST_POS','lbl_after_pos_CST_POS');
                Check_List.Percentage_pn_on_load('txt_after_MPPT_POS','lbl_after_neg_MPPT_POS','lbl_after_pos_MPPT_POS');
                Check_List.Percentage_pn_on_load('txt_after_BB_VEL','lbl_after_neg_BB_VEL','lbl_after_pos_BB_VEL');
                Check_List.Percentage_pn_on_load('txt_after_O1_POS','lbl_after_neg_O1_POS','lbl_after_pos_O1_POS');
                Check_List.Percentage_pn_on_load('txt_after_O1_VEL','lbl_after_neg_O1_VEL','lbl_after_pos_O1_VEL');
                Check_List.Percentage_pn_on_load('txt_after_O2_POS','lbl_after_neg_O2_POS','lbl_after_pos_O2_POS');
                Check_List.Percentage_pn_on_load('txt_after_O2_VEL','lbl_after_neg_O2_VEL','lbl_after_pos_O2_VEL');
                Check_List.Percentage_pn_on_load('txt_after_FOFO_POS','lbl_after_neg_FOFO_POS','lbl_after_pos_FOFO_POS');
                Check_List.Percentage_pn_on_load('txt_after_ESES_POS','lbl_after_neg_ESES_POS','lbl_after_pos_ESES_POS');
                Check_List.Percentage_pn_on_load('txt_after_FWD_POS','lbl_after_neg_FWD_POS','lbl_after_pos_FWD_POS');
                Check_List.Percentage_pn_on_load('txt_after_FWD_VEL','lbl_after_neg_FWD_VEL','lbl_after_pos_FWD_VEL');
                Check_List.Percentage_pn_on_load('txt_after_FWD_DWELL','lbl_after_neg_FWD_DWELL','lbl_after_pos_FWD_DWELL');
                Check_List.Percentage_pn_on_load('txt_after_ADV_POS','lbl_after_neg_ADV_POS','lbl_after_pos_ADV_POS');
                Check_List.Percentage_pn_on_load('txt_after_ADV_VEL','lbl_after_neg_ADV_VEL','lbl_after_pos_ADV_VEL');
                Check_List.Percentage_pn_on_load('txt_after_ADV_DWELL','lbl_after_neg_ADV_DWELL','lbl_after_pos_ADV_DWELL');
                Check_List.Percentage_pn_on_load('txt_after_REV_POS','lbl_after_neg_REV_POS','lbl_after_pos_REV_POS');
                Check_List.Percentage_pn_on_load('txt_after_REV_VEL','lbl_after_neg_REV_VEL','lbl_after_pos_REV_VEL');
                Check_List.Percentage_pn_on_load('txt_after_REV_DWELL','lbl_after_neg_REV_DWELL','lbl_after_pos_REV_DWELL');
                ...
                Check_List.Percentage_pn_on_load('txt_after_Nozzle','lbl_after_neg_Nozzle','lbl_after_pos_Nozzle','lbl_after_tol_Nozzle');
                Check_List.Percentage_pn_on_load('txt_after_Barrel1','lbl_after_neg_Barrel1','lbl_after_pos_Barrel1','lbl_after_tol_Barrel1');
                Check_List.Percentage_pn_on_load('txt_after_Barrel2','lbl_after_neg_Barrel2','lbl_after_pos_Barrel2','lbl_after_tol_Barrel2');
                Check_List.Percentage_pn_on_load('txt_after_Barrel3','lbl_after_neg_Barrel3','lbl_after_pos_Barrel3','lbl_after_tol_Barrel3');
                Check_List.Percentage_pn_on_load('txt_after_Feed_Throat','lbl_after_neg_Feed_Throat','lbl_after_pos_Feed_Throat','lbl_after_tol_Feed_Throat');
                ...
                for(b = 0; b<inj_pack_json.length;b++)
                {
                    html_inj_pack='<tr>'+
                                    ...
                                    Check_List.Percentage_pn_on_load('txt_after_Inj_Step'+b,'','','lbl_after_Inj_Step'+b,'table #injection_step_tbl');
                                    Check_List.Percentage_pn_on_load('txt_after_IStep'+b,'','','lbl_after_IStep'+b,'table #injection_step_tbl');
                ...
                Check_List.Percentage_pn_on_load('txt_after_Max_Inj_Pres','','','lbl_after_Max_Inj_Pres');
                Check_List.Percentage_pn_on_load('txt_after_Max_Inj_Time','','','lbl_after_Max_Inj_Time');
                Check_List.Percentage_pn_on_load('txt_after_Max_Pack_Velo','','','lbl_after_Max_Pack_Velo');
                Check_List.Percentage_pn_on_load('txt_after_POS_Trans','','','lbl_after_POS_Trans');
                ...
                for(c=0;c<pack_step_json.length;c++){
                    html_pack_step='<tr>'+
                                    ...
                                    Check_List.Percentage_pn_on_load('txt_after_Pack_Step'+c,'','','lbl_after_Pack_Step'+c);
                                    Check_List.Percentage_pn_on_load('txt_after_PStep'+c,'','','lbl_after_PStep'+c);
                }
                ...
                for(d=0;d<extruder_json.length;d++)
                {
                    ...
                    Check_List.Percentage_pn_on_load('txt_after_Ext_kg'+d,'','','lbl_after_Ext_kg'+d);
                    Check_List.Percentage_pn_on_load('txt_after_Ext_rpm'+d,'','','lbl_after_Ext_rpm'+d);
                    Check_List.Percentage_pn_on_load('txt_after_Ext_mm'+d,'','','lbl_after_Ext_mm'+d);
                }
                ...
                Check_List.Percentage_pn_on_load('txt_after_Mcushion','','','lbl_after_mcushion');
                Check_List.Percentage_pn_on_load('txt_after_Shot_Size','','','lbl_after_shot_size');
                Check_List.Percentage_pn_on_load('txt_after_Dcmp_Dist','','','lbl_after_Dcmp_Dist');
                Check_List.Percentage_pn_on_load('txt_after_Dcmp_Vel','','','lbl_after_Dcmp_Vel');
                Check_List.Percentage_pn_on_load('txt_after_Cool_Time','','','lbl_after_Cool_Time');
               ...
               Check_List.Percentage_pn_on_load('txt_before_OLFO_POS','lbl_before_neg_OLFO_POS','lbl_before_pos_OLFO_POS');
               Check_List.Percentage_pn_on_load('txt_before_OLFO_VEL','lbl_before_neg_OLFO_VEL','lbl_before_pos_OLFO_VEL');
               Check_List.Percentage_pn_on_load('txt_before_CS1_POS','lbl_before_neg_CS1_POS','lbl_before_pos_CS1_POS');
               Check_List.Percentage_pn_on_load('txt_before_CS1_VEL','lbl_before_neg_CS1_VEL','lbl_before_pos_CS1_VEL');
               Check_List.Percentage_pn_on_load('txt_before_CSMP_POS','lbl_before_neg_CSMP_POS','lbl_before_pos_CSMP_POS');
               Check_List.Percentage_pn_on_load('txt_before_CSMP_VEL','lbl_before_neg_CSMP_VEL','lbl_before_pos_CSMP_VEL');
               Check_List.Percentage_pn_on_load('txt_before_CST_POS','lbl_before_neg_CST_POS','lbl_before_pos_CST_POS');
               Check_List.Percentage_pn_on_load('txt_before_MPPT_POS','lbl_before_neg_MPPT_POS','lbl_before_pos_MPPT_POS');
               Check_List.Percentage_pn_on_load('txt_before_BB_VEL','lbl_before_neg_BB_VEL','lbl_before_pos_BB_VEL');
               Check_List.Percentage_pn_on_load('txt_before_O1_POS','lbl_before_neg_O1_POS','lbl_before_pos_O1_POS');
               Check_List.Percentage_pn_on_load('txt_before_O1_VEL','lbl_before_neg_O1_VEL','lbl_before_pos_O1_VEL');
               Check_List.Percentage_pn_on_load('txt_before_O2_POS','lbl_before_neg_O2_POS','lbl_before_pos_O2_POS');
               Check_List.Percentage_pn_on_load('txt_before_O2_VEL','lbl_before_neg_O2_VEL','lbl_before_pos_O2_VEL');
               Check_List.Percentage_pn_on_load('txt_before_FOFO_POS','lbl_before_neg_FOFO_POS','lbl_before_pos_FOFO_POS');
               Check_List.Percentage_pn_on_load('txt_before_ESES_POS','lbl_before_neg_ESES_POS','lbl_before_pos_ESES_POS');
               Check_List.Percentage_pn_on_load('txt_before_FWD_POS','lbl_before_neg_FWD_POS','lbl_before_pos_FWD_POS');
               Check_List.Percentage_pn_on_load('txt_before_FWD_VEL','lbl_before_neg_FWD_VEL','lbl_before_pos_FWD_VEL');
               Check_List.Percentage_pn_on_load('txt_before_FWD_DWELL','lbl_before_neg_FWD_DWELL','lbl_before_pos_FWD_DWELL');
               Check_List.Percentage_pn_on_load('txt_before_ADV_POS','lbl_before_neg_ADV_POS','lbl_before_pos_ADV_POS');
               Check_List.Percentage_pn_on_load('txt_before_ADV_VEL','lbl_before_neg_ADV_VEL','lbl_before_pos_ADV_VEL');
               Check_List.Percentage_pn_on_load('txt_before_ADV_DWELL','lbl_before_neg_ADV_DWELL','lbl_before_pos_ADV_DWELL');
               Check_List.Percentage_pn_on_load('txt_before_REV_POS','lbl_before_neg_REV_POS','lbl_before_pos_REV_POS');
               Check_List.Percentage_pn_on_load('txt_before_REV_VEL','lbl_before_neg_REV_VEL','lbl_before_pos_REV_VEL');
               Check_List.Percentage_pn_on_load('txt_before_REV_DWELL','lbl_before_neg_REV_DWELL','lbl_before_pos_REV_DWELL');
               ...
               Check_List.Percentage_pn_on_load('txt_before_Nozzle','lbl_before_neg_Nozzle','lbl_before_pos_Nozzle','lbl_before_tol_Nozzle');
               Check_List.Percentage_pn_on_load('txt_before_Barrel1','lbl_before_neg_Barrel1','lbl_before_pos_Barrel1','lbl_before_tol_Barrel1');
               Check_List.Percentage_pn_on_load('txt_before_Barrel2','lbl_before_neg_Barrel2','lbl_before_pos_Barrel2','lbl_before_tol_Barrel2');
               Check_List.Percentage_pn_on_load('txt_before_Barrel3','lbl_before_neg_Barrel3','lbl_before_pos_Barrel3','lbl_before_tol_Barrel3');
               Check_List.Percentage_pn_on_load('txt_before_Feed_Throat','lbl_before_neg_Feed_Throat','lbl_before_pos_Feed_Throat','lbl_before_tol_Feed_Throat');
                ...
                for(b = 0; b<inj_pack_json.length;b++)
                {
                    html_inj_pack='<tr>'+
                                    ...
                                    Check_List.Percentage_pn_on_load('txt_before_Inj_Step'+b,'','','lbl_before_Inj_Step'+b,'table #pack_step_tbl_before');
                                    Check_List.Percentage_pn_on_load('txt_before_IStep'+b,'','','lbl_before_IStep'+b,'table #pack_step_tbl_before');
                ...
                Check_List.Percentage_pn_on_load('txt_before_Max_Inj_Pres','','','lbl_before_Max_Inj_Pres');
                Check_List.Percentage_pn_on_load('txt_before_Max_Inj_Time','','','lbl_before_Max_Inj_Time');
                Check_List.Percentage_pn_on_load('txt_before_Max_Pack_Velo','','','lbl_before_Max_Pack_Velo');
                Check_List.Percentage_pn_on_load('txt_before_POS_Trans','','','lbl_before_POS_Trans');
                ...
                for(c=0;c<pack_step_json.length;c++){
                    html_pack_step='<tr>'+
                                    ...
                                    Check_List.Percentage_pn_on_load('txt_before_Pack_Step'+c,'','','lbl_before_Pack_Step'+c);
                                    Check_List.Percentage_pn_on_load('txt_before_PStep'+c,'','','lbl_before_PStep'+c);
                }
               ...
               for(d=0;d<extruder_json.length;d++)
               {
                   ...
                   Check_List.Percentage_pn_on_load('txt_before_Ext_kg'+d,'','','lbl_before_Ext_kg'+d);
                   Check_List.Percentage_pn_on_load('txt_before_Ext_rpm'+d,'','','lbl_before_Ext_rpm'+d);
                   Check_List.Percentage_pn_on_load('txt_before_Ext_mm'+d,'','','lbl_before_Ext_mm'+d);
               }
               ...
               Check_List.Percentage_pn_on_load('txt_before_Mcushion','','','lbl_before_mcushion');
               Check_List.Percentage_pn_on_load('txt_before_Shot_Size','','','lbl_before_shot_size');
               Check_List.Percentage_pn_on_load('txt_before_Dcmp_Dist','','','lbl_before_Dcmp_Dist');
               Check_List.Percentage_pn_on_load('txt_before_Dcmp_Vel','','','lbl_before_Dcmp_Vel');
               Check_List.Percentage_pn_on_load('txt_before_Cool_Time','','','lbl_before_Cool_Time');
    ...
    this_data.mark_check = function(){
        var after_id =   $('.modal_view_data').attr('data-afterid');

        Swal.fire({
            title: 'Are you sure you want to mark the record as already checked? ',
            html: "You won't be able to revert this. Records already checked will be displayed at the Review List Section",
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            cancelButtonText: 'Cancel',
            confirmButtonText: 'Yes, Mark as Checked!'
          }).then((result) => {
            if (result.value) 
            {
                $.ajax({
                    url:"check_list/mark_checked",
                    type:"POST",
                    data: {
                    ...
                    success:function(data){
                        ...
                        $('.modal_view_data').modal('hide');
                        Check_List.loadtable('destroy');
                        badges.loadbadge();
                    },
                    error:function(data){
                        console.log(data);
    ...
    this_data.clear_search = function(module_name){
        ...
        if(module_name =="check"){
            ...
            Review_List.loadtable('destroy');
        }
        else if(module_name=="approve"){
            Approve_List.loadtable('destroy');
        }
    }

    this_data.delete_record = function(module_name){
        ...
        Swal.fire({
            ...
            html: "The record will be deleted but the adjustments made will retain for adjustment history reference.",
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
...
var Review_List = (function(){
    ...
    this_data.mark_review = function(){

        var after_id =   $('.modal_view_data').attr('data-afterid');
        Swal.fire({
            title: 'Are you sure you want to mark the record as already reviewed? ',
            html: "You won't be able to revert this. Records already checked will be displayed at the Approval List Section",
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
...
var Approve_List = (function(){
    ...
    this_data.mark_approve = function(){

        var after_id =   $('.modal_view_data').attr('data-afterid');
        Swal.fire({
            title: 'Are you sure you want to mark the record as already approved? ',
            html: "You won't be able to revert this. Records already checked will be displayed at the Set up List Section",
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
                        ...
                        for(a = 0; a< loop_limit; a++){
                            ...
                            if(parameter_setting=='mct_setting'){
                                row+='<td> '+'MCT SETTING'+'</td>'+
                                    ...
                                    '<td>'+reason+'</td>'+'<td style="width: 40vw" id="original_condition">'+
                                    ...
                                    ' </div>'+
                                    '</td>'+
                                    '<td style="width: 40vw" id="adjusted_condition">'+
                                    '<div class="table-responsive" >'+
                                        '<table class="table table-bordered text-center table-striped bold-text" >'+
                                        ' <thead>'+
                                                '<tr>'+
                                ...
                                '<td> '+ value['after_data'][a].created_at+' </td>'+
                                '<td>'+reason+'</td>'+
                                '<td style="width: 40vw" id="original_condition">'+
